package com.image.fastdfs.enums;
...
public enum ResultCodeEnum {
    ...
    INTF_OUT_OF_SERVICE("2002", "接口服务暂时无法提供服务"),
    TOKEN_ERR("2003", "token无效"),

    INVALID_REQUEST_QO_EMPTY("400001", "参数错误,请求对象为空"),
    INVALID_REQUEST_MISSING_REQUIRE_FIELD("400002", "参数错误,请求对象缺少必要信息");

    private final String code;
    private final String message;

    ResultCodeEnum(final String code, final String message) {
        this.code = code;
